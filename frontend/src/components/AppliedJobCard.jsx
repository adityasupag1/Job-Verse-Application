...
export const AppliedJobCard = ({id, job, time }) => {
    ...
    return (
        <div className='text-black bg-green-600 flex flex-col gap-2  shadow-sm shadow-gray-800 border border-gray-700 md:px-4 px-3 w-full py-2'>
                ...
                <div className='flex flex-col '>
                    ...
                    <div className='flex justify-between gap-2 '>
                        ...
                        <div className='absolute md:right-3 right-0 md:pt-0 md:top-3 top-18  flex flex-col gap-3' >
                            <Link to={`/Application/Details/${id}`} className='bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 rounded-md font-semibold md:text-sm 
