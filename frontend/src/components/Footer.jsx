...
export const Footer = () => {
	return (
		<>
			<div className="bg-[#007bffd2] text-white py-3 pt-5 grid md:grid-cols-3 grid-cols-1 md:gap-6 gap-3 md:justify-center">
				...
				<div>
					...
					<div className="flex gap-5 py-2 justify-center items-center">
						...
						/>
						<a
							href="https://instagram.com/aditya.supagyk"
							target="_blank"
						...
						<a
							href="mailto:araj15397@gmail.com"
							target="_blank"
							rel="noopener noreferrer"
						>
							<AiFillMail
