...
export const Navbar = () => {
    ...
    return (
        <>
            <div className='text-white z-20 fixed min-w-full bg-[#007bffd2] pb-2'>
              {!isMobile &&  <ul className='sm:flex  justify-center items-center gap-12 pt-4 pb-3 font-semibold text-xl'>
                    <Link to="/" className='flex fixed left-24 justify-center items-center titleT'>
                        <MdOutlineBusinessCenter size={40} />  JOB VERSE
                    </Link>
                    ...
                    {isLogin ? (
                        ...
                        <span className='fixed right-24 flex gap-3'>
                            <Link className='cursor-pointer text-sm px-4 py-1 rounded-m bg-white text-black border-cyan-500 rounded-lg hover:bg-blue-500' to="/login">Login</Link>
                            <Link className='cursor-pointer text-sm px-4 py-1 rounded-lg bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500' to="/register">Register</Link>
                        </span>
                    )}
                </ul>}
                ...
                <div className='py-3 px-3 md:hidden justify-between items-center flex'>
                    <Link to="/" className='text-lg titleT flex justify-center items-center gap-1'>
                        <MdOutlineBusinessCenter size={19} /> JOB VERSE
                    </Link>
