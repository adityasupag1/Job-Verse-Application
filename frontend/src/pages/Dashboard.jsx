              ...
              <div className='grid md:grid-cols-3 grid-cols-1 md:gap-0 gap-16 md:pt-28 pt-16 pb-28'>
                ...
                <div className='flex  flex-col gap-3  justify-center items-center '>
                  <div className='text-8xl '>
                    {typeof allUsers?.length === 'number' && (
                      <CountUp start={0} end={allUsers.length} duration={2} redraw />
                    )}
                ...
                <div className='flex flex-col gap-3  justify-center items-center '>
                  <div className='text-8xl '>
                    {typeof allJobs?.length === 'number' && (
                      <CountUp start={0} end={allJobs.length} duration={2} redraw />
                    )}
                ...
                <div className='flex flex-col gap-3  justify-center items-center '>
                  <div className='text-8xl '>
                    {typeof allApplications?.length === 'number' && (
                      <CountUp start={0} end={allApplications.length} duration={2} redraw />
                    )}
                    {/* <CountUp start={0} end={allApplications && allApplications?.length} /> */}
                  </div>
