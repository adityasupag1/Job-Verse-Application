                        ...
                        <form onSubmit={deleteHandler} className='flex flex-col md:w-1/3 shadow-gray-700  w-full md:mx-0 mx-4' action="">
                            ...
                            <div className='md:px-10 px-6 py-6 shadow-sm shadow-gray-700 border-gray-700 border w-full flex flex-col gap-4'>
                                <div className='text-center pb-3'>
                                    <p className='md:text-4xl text-3xl text-red-500  font-semibold border-b pb-2 border-gray-700'>Delete Account</p>
                                </div>
                                ...
                                <div>
                                    <button disabled={loading || !confirm} className='bg-red-600 text-white px-8 w-full py-2 flex justify-center items-center font-semibold' >{loading ? <TbLoader2 className='animate-spin' size={24} /> : "Delete"}</button>
                                </div>
