              ...
              <Sidebar sideTog={sideTog} />
                            ...
                            <div className='py-4 '>
                                ...
                                <div className="flex gap-4">
                                    <div>
                                        <select onChange={(e)=>setStatus(e.target.value)} id="large" class="rounded-md block w-full px-6 py-3 text-base  border bg-gray-900 border-gray-600 placeholder-gray-400 text-white ">
                                    ...
                                    <button onClick={()=>updateStatusHandler()} className="bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 rounded-md py-2 px-6">
                                        Update Status
                                    </button>
                                </div>
