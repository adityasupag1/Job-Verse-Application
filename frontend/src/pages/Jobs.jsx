...
export const Jobs = () => {
  ...
  const totalPageCount = Math.ceil((jobs?.length || 0) / itemsPerPage);
  ...
  for (let i = startButton; i <= endButton; i++) {
    pageButtons.push(
      <button
        ...
        className={`mx-1 px-3 py-1 border border-gray-700 rounded ${currentPage === i ? 'bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500  text-black' : 'bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500  text-black hover:bg-gray-500 hover:text-black'}`}
      >
        {i}
      </button>
    );
  ...
  return (
    <>
      <MetaData title="Jobs" />
      <div className='bg-gray-100 min-h-screen pt-14 sm:px-20 px-3  text-black'>
            ...
            <div className='flex-col flex justify-center items-center w-full '>
              ...
              <div className='py-3 pt-4 w-full flex justify-center items-center'>
                ...
                <div className='flex  justify-center w-full  items-center  '>
                  <div className='bg-white rounded-md flex sm:w-2/5 w-4/5'>
                    ...
                    ${search.length !== 0 ? "flex" : "hidden"}
                     `} /></div>
                    <button onClick={() => searchHandler()} className='bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 text-white rounded-md sm:text-sm text-xs px-4 sm:h-10 h-8 py-1'>Search</button>
                  </div>
                </div>
                ...
                {!isMobile && <div className='filter1  flex  flex-col'>
                  <div className='flex justify-start  flex-col filter  '>
                    ...
                    <div className='flex flex-col gap-4 w-2/3 pt-5'>
                      <button onClick={() => leftFilter(jobs)} className='bg-orange-600 px-1 py-1 text-xs rounded-md'>Apply Filter</button>
                      <button onClick={() => removeLeftFilter()} className='bg-orange-600 px-1 py-1 text-xs rounded-md'>Remove Filter</button>
                    </div>
                    ...
                    <div className='flex  flex-col'>
                      ...
                      <div className="flex justify-center mt-1">
                        <button
                          ...
                          className="bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 rounded-m text-black font-bold py-2 px-4 mr-2"
                        >
                          Previous
                        </button>
                        ...
                        <button
                          ...
                          className="bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 rounded-m text-black font-bold py-2 px-4 ml-2"
                        >
                          Next
                        </button>
                      </div>
                        ...
                        <div className='filter1  sm:hidden flex flex-col'>
                          <div className='flex justify-start  flex-col filter  '>
                            ...
                            <div className='flex text-sm flex-col gap-4 w-2/3 pt-5'>
                              <button onClick={() => leftFilter(jobs)} className='bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 rounded-md px-1 py-1 text-xs'>Apply Filter</button>
                              <button onClick={() => removeLeftFilter()} className='bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 rounded-md blueCol px-1 py-1 text-xs'>Remove Filter</button>
                            </div>
                        ...
                        <div className='filter2  sm:hidden flex flex-col ml-16'>
                          <div className='flex justify-end  flex-col filter  '>
                            ...
                            <div className='flex text-sm flex-col gap-4 pt-5'>
                              <button onClick={() => rightFilter(jobs)} className='bg-orange-600 rounded-md px-1 py-1 text-xs'>Apply Search</button>
                              <button onClick={() => removeRightFilter()} className='bg-orange-600 rounded-md px-1 py-1 text-xs'>Remove Search</button>
                            </div>
                          </div>
