        ...
        <div className=' flex justify-center w-full items-start pt-14'>
          <form onSubmit={loginHandler} className='flex  flex-col md:w-1/3 shadow-gray-700  w-full md:mx-0 mx-8' action="">
            ...
            <div className='md:px-10 px-2 py-6 w-full flex flex-col gap-4'>
              ...
              <div>
              <button disabled={loading || !email || !password} className='bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 text-white px-8 w-full py-2 flex justify-center items-center font-semibold' >{loading ? <TbLoader2 className='animate-spin' size={24} /> : "Login"}</button>
              </div>
              <div className='text-center text-sm pt-2'>
                <p>Don't have an account, <Link to="/register" className='text-blue-400 hover:underline'>Register</Link> here. </p>
              </div>
