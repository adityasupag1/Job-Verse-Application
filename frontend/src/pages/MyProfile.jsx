              ...
              <div className='flex md:flex-row md:gap-12 flex-col md:justify-around justify-center items-top md:pt-12  border-blue-500 min-h-[90vh] ' >
                ...
                <div className=' md:w-1/2 w-full md:pb-0 pt-16  md:pt-10 gap-8 flex flex-col justify-start items-center '>
                  ...
                  <div className='flex justify-center items-center'>
                    <Link to="/editProfile" className='rounded-md bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 px-10 py-2 font-semibold'>Edit Profile</Link>
                  </div>
                </div>
                  ...
                  <div className='flex flex-col md:gap-5 gap-6'>
                    ...
                    <div className='flex md:flex-row flex-col md:gap-8 pt-4 gap-3'>
                      <ul className='flex flex-col gap-4'>
                        ...
                        <li className=' '> <Link  ><button onClick={open} className='rounded-md bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 w-2/3 md:w-full  font-medium px-6 py-1'>My Resume</button></Link> </li>
                        <li className=' '>
                          <Link to="/applied"><button className='rounded-md bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 w-2/3 md:w-full font-medium px-6 py-1'>My Applications</button></Link>
                        </li>
                        <li className=' '>
                          <Link to="/saved" ><button className='rounded-md bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 w-2/3 md:w-full font-medium px-6 py-1'>Saved Jobs</button></Link>
                        </li>

                      </ul>
                      <ul className='flex flex-col gap-4'>
                        <li className=' '>
                          <Link to="/changePassword"><button className='rounded-md bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 w-2/3 md:w-full font-medium px-6 py-1'>Change Password</button></Link>
                        </li>
                        <li className=' '><Link to="/deleteAccount"><button className='rounded-md bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 w-2/3 md:w-full font-medium px-6 py-1'>Delete Account</button></Link></li>
                      </ul>
