          ...
          <form onSubmit={registerHandler} className='flex flex-col md:w-1/3 shadow-gray-700  w-full md:mx-0 mx-8' action="">
            ...
            <div className='md:px-10 px-2 pt-4 pb-20 w-full flex flex-col gap-4'>
              ...
              <div>
                ...
                <p className='bg-gray-500 text-white text-xs'>Please select Image file</p>
              </div>
              ...
              <div>
                <button disabled={loading} className='rounded-m bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 flex justify-center items-center px-8 w-full py-2 font-semibold' >
