       ...
       <div className="pt-1 fixed left-0 z-20 pl-0">
        ...
        <Sidebar sideTog={sideTog} />
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <thead className="text-xs text-gray-200 uppercase bg-gradient-to-r from-blue-500 to-teal-400 hover:from-pink-500 hover:to-orange-500 dark:text-gray-200">
                <tr>
              ...
              <tbody>
               ...
               .sort((a, b) => {
                ...
                <tr key={i} className=" border-b hover:bg-gray-400 bg-gray-300 border-gray-700 text-black">
